...
import { Dimensions, View, TouchableOpacity, ScrollView, Image } from 'react-native';
        ...
        <Footer style={{ height: height * 0.25, backgroundColor: '#FFF', borderColor: '#FFF', borderTopWidth: 0, elevation: 0 }}>
          <Grid>
            <Row>
              ...
              <Col style={styles.col_exercise}>
                <View style={{
                  borderWidth: 2, borderColor: '#f39c12', borderRadius: 50, height: 100, width: 100, alignItems: 'center',
