...
import { ImageBackground, Dimensions, View, ScrollView } from 'react-native';
import { Container, Body, Text, Right, List, ListItem, Thumbnail ,Icon} from 'native-base';
        ...
        <ScrollView>
          ...
          <View style={{ padding: 10, paddingTop: 10, backgroundColor: '#FFF' }}>
            <List>
              ...
              <ListItem style={styles.listitem_home} onPress={this.navigateToScreen('Meetup')}>
