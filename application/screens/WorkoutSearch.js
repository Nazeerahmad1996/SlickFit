...
import { Dimensions, View, Slider, ScrollView } from 'react-native';
import { Container, Button, Icon, Picker, Form, Text, ListItem, Left, Right } from "native-base";
      ...
      <Container style={styles.background_general}>
        <ScrollView>
          ...
          <View style={{ flex: 1, flexDirection: 'column', alignItems: 'center', padding: 15 }}>
            ...
            <View style={{ height: 2, backgroundColor: '#F62459', width: 50, marginBottom: 25, }} />
            <Form>
